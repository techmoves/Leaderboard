...
Use the git clone command followed by the repository's URL to clone the repository. For example: git clone https://github.com/techmoves/Leaderboard.git
...
- [X] **[Learder board add score]**
- [x] **[leader board add and and refresh]**
- [X] **[Set Local Storage]**
- [X] **[add list]**
